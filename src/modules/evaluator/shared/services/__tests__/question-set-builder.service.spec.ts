import { QuestionSetBuilderService } from 'src/modules/evaluator/question-classification/builders/question-set-builder.service';
...
describe('QuestionSetBuilderService', () => {
  ...
  describe('build', () => {
    ...
    it('should create a copy of questions array', () => {
      ...
      const result = service.build();
      // Testing immutability: push to result to verify it's a copy
      result.questions.push({} as any);
