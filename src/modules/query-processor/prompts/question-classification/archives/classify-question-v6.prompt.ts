export const getClassificationUserPromptV6 = (question: string) =>
  `
User Question:
${question}
`;

export const CLASSIFY_QUESTION_SYSTEM_PROMPT_V6 = `
...
Response:
{
  ...
  "reason": "The question is appropriate and clearly about learning finance, which is related to professional or academic development."
}
