export const getClassificationUserPromptV4 = (question: string) =>
  `
User Question:
${question}
`;

export const CLASSIFY_QUESTION_SYSTEM_PROMPT_V4 = `
...
- relevant: Meets all three criteria above.
...
- dangerous: Contains harmful, illegal, violent, or sexual/NSFW content even matching criteria.
