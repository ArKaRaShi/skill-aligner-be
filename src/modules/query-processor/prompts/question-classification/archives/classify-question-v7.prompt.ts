export const getClassificationUserPromptV7 = (question: string) => `
User Question:
${question}
`;

export const CLASSIFY_QUESTION_SYSTEM_PROMPT_V7 = `
...
- relevant: Matches patterns A-H and does not contain harmful, illegal, violent, or sexual/NSFW content
- dangerous: Matches patterns A-H but contains harmful, illegal, violent, or sexual/NSFW content
- irrelevant: Safe question but fails skill extraction criteria or violates limitations
...
Response:
{
  ...
  "reason": "Too vague, no domain or learning intent provided"
}
