export const getAnswerSynthesisUserPromptV15 = (
  question: string,
  context: string,
) => `
...
export const ANSWER_SYNTHESIS_SYSTEM_PROMPT_V15 = `
...
Step 6: Conclude with a scope-aware exploratory summary.
- End the response with a short paragraph that summarizes what aspects or skills are represented by the available courses.
- Clearly state whether any course directly matches the user's stated intent.
- If no direct match exists, describe the courses strictly as contextual, foundational, or adjacent perspectives found in the current dataset.
- Do NOT imply learning pathways, outcomes, or preparedness beyond what is explicitly stated in the course learning outcomes.
I
---
