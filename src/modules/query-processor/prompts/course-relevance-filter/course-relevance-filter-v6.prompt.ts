...
export const getCourseRelevanceFilterUserPromptV6 = (
  question: string,
  skill: string,
  coursesData: string,
) => `
...
export const COURSE_RELEVANCE_FILTER_SYSTEM_PROMPT_V6 = `
...
CRITICAL: You MUST return a score for EVERY course in the provided list. Use course_code as the primary identifier (course names may be identical to the skill or each other—do not skip or merge courses).

Instructions:
1. Evaluate each course based on BOTH the course content AND learning outcomes
