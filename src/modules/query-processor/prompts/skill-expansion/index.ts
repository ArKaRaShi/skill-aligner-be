...
import {
  EXPAND_SKILL_SYSTEM_PROMPT_V11,
  getExpandSkillUserPromptV11,
} from './expand-skill-v11.prompt';
import {
...
> = {
  ...
  v11: {
    systemPrompt: EXPAND_SKILL_SYSTEM_PROMPT_V11,
    getUserPrompt: getExpandSkillUserPromptV11,
  },
};
